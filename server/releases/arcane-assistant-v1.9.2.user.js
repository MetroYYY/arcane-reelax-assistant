...
(() => {
  ...
  var UPDATE_NOTES = "\u3010\u4FEE\u590D\u3011\n\n- \u4FEE\u590D\u53CC\u5730\u56FE\u516C\u4F1A\u8D5B\u53EF\u80FD\u8BEF\u5C06\u5730\u56FE 1 \u5F53\u4F5C\u672C\u516C\u4F1A\u53C2\u8D5B\u5730\u56FE\u7684\u5207\u56FE\u95EE\u9898\uFF1B\u5F00\u8D5B\u65F6\u4F1A\u5237\u65B0\u5206\u914D\u7ED3\u679C\uFF0C\u7ED3\u679C\u672A\u4E0B\u53D1\u524D\u4E0D\u4F1A\u9519\u8BEF\u5207\u56FE\u3002\n\n\u3010\u4F18\u5316\u3011\n\n- \u4F18\u5316\u4E16\u754C Boss \u7684\u65E5\u5FD7\u8F93\u51FA\u63CF\u8FF0\u3002\u76F8\u5173\u529F\u80FD\u5DF2\u5B8C\u6210\u4E00\u6B21\u5B9E\u9645\u6D4B\u8BD5\uFF0C\u6682\u672A\u53D1\u73B0\u95EE\u9898\uFF0C\u56E0\u6B64\u79FB\u9664\u6D4B\u8BD5\u8B66\u544A\u3002";
...
${body}`;
  ...
  var SECTION_HINTS = {
    ...
    worldboss: "\u81EA\u52A8\u62A5\u540D Boss \u5F31\u70B9\uFF0C\u5F00\u6253\u524D\u6309\u8BBE\u7F6E\u5207\u6362\u88C5\u5907\u5E76\u6D17\u6210\u5F31\u70B9\u5C5E\u6027\uFF0C\u9996\u51FB\u5FEB\u7167\u9501\u5B9A\u540E\u6062\u590D\u6BD4\u8D5B\u6216\u5E38\u9A7B\u65B9\u6848\u3002",
...
<div id="update-popup" style="display:none;position:fixed;inset:0;z-index:2147483601;background:rgba(15,23,42,0.45);align-items:center;justify-content:center;">
  ...
  function getCurrentBuffSelection() {
    ...
    const compSelected = Object.keys(settings.buffSelections?.competition || {}).filter((k) => settings.buffSelections.competition[k] === true);
    const key = onAnyCompMap() && compSelected.length ? "competition" : weatherId;
    const selected = key === "competition" ? compSelected : Object.keys(settings.buffSelections?.[key] || {}).filter((k) => settings.buffSelections[key]?.[k] === true);
    return { key, selected };
  }
  async function checkAndBuyBuffs() {
    if (!settings.autoBuyBuffs) return;
    const { selected: sel } = getCurrentBuffSelection();
