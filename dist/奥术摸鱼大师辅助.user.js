...
(() => {
  ...
  var DEFAULTS = {
    ...
    autoEquipmentProfiles: false,
    profileEngineMode: "legacy",
...
${message.content}`;
  ...
  function setupEmbeddedPanelHost(host) {
    ...
    const mountNavigation = () => {
      ...
      group.innerHTML = `<span class="nav-group-title">脚本管理</span><a href="#" class="nav-item" data-arcane-assistant-open aria-label="奥术摸鱼大师辅助" title="奥术摸鱼大师辅助"><svg viewBox="0 0 24 24" aria-hidden="true" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 15c3-5 7-7 12-7h4l-3 3 3 3h-4c-5 0-9-2-12-7z"/><circle cx="15.5" cy="10.5" r=".8" fill="currentColor"/></svg><span class="nav-label">辅助设置</span></a>`;
