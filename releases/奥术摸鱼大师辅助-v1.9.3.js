...
(() => {
  ...
  var SURVEY_ID = "sponsorship-survey-v1";
  ...
  var TAG_COLORS = { "\u5730\u56FE\u5BFC\u822A": "#4a9eff", "\u6BD4\u8D5B\u8F85\u52A9": "#4ade80", "\u4E16\u754C Boss": "#f472b6", "\u5965\u79D8\u732E\u796D": "#8b5cf6", "\u516C\u4F1A\u533A\u57DF\u589E\u76CA": "#16a34a", "\u5C5E\u6027\u52A0\u70B9": "#f59e0b", "\u9C7C\u9975\u5207\u6362": "#fbbf24", "Buff \u8D2D\u4E70": "#e6a23c", "\u51FA\u552E\u9C7C\u7C7B": "#eab308", "\u51FA\u552E\u88C5\u5907": "#a855f7", "\u901A\u7528\u8F85\u52A9": "#2dd4bf", "\u663E\u793A\u4E0E\u7EDF\u8BA1": "#c084fc", "\u53CD\u9988": "#38bdf8", "\u4E3B\u7A0B\u5E8F": "#64748b" };
  var LOG_SCOPE = {
    "\u62A5\u540D": ["\u6BD4\u8D5B\u8F85\u52A9", "\u62A5\u540D", true],
    "\u6D17\u70B9": ["\u6BD4\u8D5B\u8F85\u52A9", "\u6D17\u70B9", true],
    "\u914D\u88C5": ["\u6BD4\u8D5B\u8F85\u52A9", "\u914D\u88C5", true],
...
${body}`;
  ...
  function startArcaneSacrifice() {
    ...
    state._arcaneSacrificeTimer = setInterval(() => checkArcaneSacrifice("\u6BCF3\u5206\u949F\u91CD\u65B0\u68C0\u67E5"), CHECK_INTERVAL_MS);
  ...
  function isSurveyFilled() {
    return settings.surveySubmittedId === SURVEY_ID;
  }
  ...
  function updateFeedbackBadge() {
    ...
    if (b) b.style.display = isSurveyFilled() ? "none" : "";
  }
  function renderFeedbackUI() {
    ...
    surveySec.innerHTML = '<div class="section-heading"><strong>\u8D5E\u52A9\u610F\u613F\u8C03\u67E5</strong><span style="font-size:11px;color:var(--as-muted)">\u6BCF\u4EBA\u4EC5\u4E00\u6B21</span></div>';
    const sponsorPromise = document.createElement("div");
    sponsorPromise.style.cssText = "margin:4px 0 10px;padding:8px 10px;border:1px solid var(--as-border);border-radius:4px;background:var(--as-control);color:var(--as-text);font-size:12px;line-height:1.7;";
    sponsorPromise.textContent = "\u8D5E\u52A9\u5B8C\u5168\u81EA\u613F\uFF0C\u4E0D\u4F1A\u5F71\u54CD\u4EFB\u4F55\u811A\u672C\u529F\u80FD\u3002\u82E5\u5F00\u653E\u8D5E\u52A9\uFF0C\u6536\u5230\u7684\u5168\u90E8\u8D5E\u52A9\u5C06\u53EA\u7528\u4E8E\u8D2D\u4E70\u81EA\u7136\u8BED\u8A00\u7FFB\u8BD1\u5B98 DeepSeek \u6216 ChatGPT \u7684\u4F7F\u7528\u989D\u5EA6\uFF0C\u7528\u4E8E\u5F25\u8865\u811A\u672C\u5F00\u53D1\u3001\u8C03\u8BD5\u548C\u7EF4\u62A4\u82B1\u9500\u3002";
    surveySec.appendChild(sponsorPromise);
    if (isSurveyFilled()) {
          ...
          q.options.forEach((opt) => {
            ...
            inp.addEventListener("change", () => {
              if (q.type === "multi") {
                ...
                inputs[q.id] = opt;
                if (q.id === "acceptSponsor") {
                  restWrap.style.display = opt === "\u4E0D\u63A5\u53D7" ? "none" : "";
                  if (opt === "\u4E0D\u63A5\u53D7") {
                    for (const qq of SURVEY_QUESTIONS) if (qq.id !== "acceptSponsor") {
                      delete inputs[qq.id];
                      delete custom[qq.id];
                    }
                  }
      ...
      for (const q of SURVEY_QUESTIONS) {
        addQuestion(q, q.id === "acceptSponsor" ? surveySec : restWrap);
      }
      ...
      submitBtn.addEventListener("click", async () => {
        ...
        if (!armed) {
          if (!merged.acceptSponsor) {
            showSurveyStatus("\u8BF7\u5148\u9009\u62E9\u662F\u5426\u63A5\u53D7\u81EA\u613F\u8D5E\u52A9\u5165\u53E3", true);
            return;
          }
          if (merged.acceptSponsor !== "\u4E0D\u63A5\u53D7") {
            for (const q of SURVEY_QUESTIONS) {
              if (q.id === "acceptSponsor") continue;
  ...
  function renderWorldBossSection() {
    ...
    const master = _sellSwitchRow("\u542F\u7528\u4E16\u754C Boss \u8F85\u52A9", settings.autoWorldBoss, (v) => {
      ...
      applySettings();
    }, "\u81EA\u52A8\u62A5\u540D Boss \u5F31\u70B9\uFF0C\u5E76\u6309\u8BBE\u7F6E\u5728\u5F00\u6253\u524D\u51C6\u5907\u5C5E\u6027\u548C\u88C5\u5907\uFF1B\u9996\u51FB\u5FEB\u7167\u9501\u5B9A\u540E\u6062\u590D\u6BD4\u8D5B\u6216\u5E38\u9A7B\u65B9\u6848\u3002\u5173\u95ED\u65F6\u4F1A\u4FDD\u7559\u914D\u7F6E\uFF1B\u5982\u679C\u6B63\u5728\u51C6\u5907 Boss\uFF0C\u4F1A\u5148\u6062\u590D\u539F\u6765\u7684\u5C5E\u6027\u548C\u88C5\u5907\u3002");
    master.classList.add("master-switch");
    ctr.appendChild(master);
    ...
    }, "\u8BFB\u53D6\u6307\u5B9A Boss \u914D\u88C5\u7684\u56DB\u7EF4\u6700\u7EC8\u9762\u677F\uFF0C\u6309\u5F31\u70B9 \xD7200%\u3001\u9632\u5FA1 \xD750%\u3001\u5176\u4ED6 \xD7100% \u8BA1\u7B97\u6700\u9AD8\u4F24\u5BB3\u5E76\u62A5\u540D\u3002\u5F00\u6218\u524D\u53EA\u5207\u6362\u8BE5\u914D\u88C5\u3001\u4E0D\u6D17\u70B9\uFF0C\u5E76\u4FDD\u6301\u5230\u9996\u51FB\u5FEB\u7167\u9501\u5B9A\uFF1B\u968F\u540E\u82E5\u6B63\u5728\u5BF9\u5E94\u6BD4\u8D5B\u5730\u56FE\uFF0C\u7ACB\u5373\u4EA4\u7ED9\u6BD4\u8D5B\u5207\u88C5/\u6D17\u70B9\u903B\u8F91\u3002"));
    ctr.appendChild(_sellSwitchRow("\u5F00\u6253\u524D\u81EA\u52A8\u6D17\u5F31\u70B9\u5C5E\u6027", settings.autoWorldBossRespec, (v) => {
      ...
      renderWorldBossSection();
    }, "\u5F00\u6253\u524D\u81EA\u52A8\u628A\u5C5E\u6027\u70B9\u5168\u52A0\u5230 Boss \u5F31\u70B9\u3002\u4E0E\u201C\u4E0D\u6D17\u70B9\u6700\u9AD8\u4F24\u5BB3\u201D\u4E92\u65A5\u3002\u6BCF\u6B21\u6D17\u70B9\u82B1\u8D39 10,000 \u91D1\u5E01\uFF1B\u6253\u51FA\u7B2C\u4E00\u51FB\u540E\u81EA\u52A8\u6062\u590D\u3002\u53EA\u6709\u4ECD\u5728\u6BD4\u8D5B\u5730\u56FE\u3001\u4E14\u672C\u573A\u6CA1\u6709\u8DF3\u8FC7\u6216\u8E6D\u5956\u5B8C\u6210\u65F6\uFF0C\u624D\u6062\u590D\u6BD4\u8D5B\u5168\u5E78\u8FD0\u3002"));
    ...
    ctr.appendChild(_sellSwitchRow("\u5F00\u6253\u524D\u81EA\u52A8\u6362 Boss \u88C5\u5907", settings.autoWorldBossLoadout, (v) => {
      ...
      renderWorldBossSection();
    }, "\u5F00\u6253\u524D\u6362\u4E0A Boss \u88C5\u5907\uFF0C\u6253\u51FA\u7B2C\u4E00\u51FB\u540E\u6362\u56DE\u6765\u3002\u82E5\u6BD4\u8D5B\u6B63\u5728\u8FDB\u884C\uFF0C\u5219\u6362\u6210\u6BD4\u8D5B\u88C5\u5907\u3002\u201C\u4E0D\u6D17\u70B9\u6700\u9AD8\u4F24\u5BB3\u201D\u6A21\u5F0F\u5FC5\u987B\u5F00\u542F\u6B64\u9879\u3002"));
  ...
  function renderArcaneSacrificeSection() {
    ...
    const master = _sellSwitchRow("\u542F\u7528\u81EA\u52A8\u732E\u796D\uFF08\u6D4B\u8BD5\uFF09", settings.autoArcaneSacrifice, (value) => {
      ...
      saveSettings();
      applySettings();
    }, "\u26A0\uFE0F \u672C\u529F\u80FD\u4ECD\u5904\u4E8E\u6D4B\u8BD5\u9636\u6BB5\u3002\u4F7F\u7528\u65F6\u5EFA\u8BAE\u540C\u65F6\u5F00\u542F\u300C\u663E\u793A\u8C03\u8BD5\u65E5\u5FD7\u300D\uFF0C\u89C2\u5BDF\u68C0\u67E5\u3001\u964D\u7EA7\u3001\u63D0\u4EA4\u3001\u786E\u8BA4\u548C\u8FBE\u6807\u6D41\u7A0B\u662F\u5426\u6B63\u5E38\uFF1B\u5982\u679C\u53D1\u73B0\u5F02\u5E38\uFF0C\u8BF7\u7ACB\u5373\u5173\u95ED\u672C\u5F00\u5173\uFF0C\u5E76\u5728\u300C\u53CD\u9988 \u2192 bug\u53CD\u9988\u300D\u4E2D\u63D0\u4EA4\u95EE\u9898\uFF0C\u811A\u672C\u4F1A\u81EA\u52A8\u9644\u5E26\u65E5\u5FD7\u548C\u9762\u677F\u8BBE\u7F6E\u3002\u732E\u796D\u5F00\u653E\u65F6\u4F1A\u5148\u8BFB\u53D6\u670D\u52A1\u7AEF\u672C\u8F6E\u4E2A\u4EBA\u7D2F\u8BA1\u8D21\u732E\uFF1B\u8D44\u6E90\u4E0D\u8DB3\u65F6\u6BCF3\u5206\u949F\u91CD\u65B0\u68C0\u67E5\uFF0C\u76F4\u5230\u672C\u8F6E\u5173\u95ED\u3002\u9C7C\u7C7B\u4F18\u5148\u7CBE\u51C6\u51D1\u5206\uFF0C\u65E0\u6CD5\u7CBE\u51C6\u51D1\u9F50\u65F6\u6700\u591A\u5141\u8BB8\u6BD4\u76EE\u6807\u591A30\u5206\u3002");
    ...
    disp.forEach((key, i) => {
      ...
      if (key === "designated") {
        ...
        if (key === "competition" && !disabled) {
          ...
          const h2Arcane = makeHint("\u4EC5\u5BF9\u5DF2\u7ECF\u5B8C\u6210\u300C\u67AF\u6F6E\u8E6D\u5956\u300D\u5E76\u79BB\u573A\u7684\u672C\u573A\u4E2A\u4EBA\u8D5B\u751F\u6548\u3002\u811A\u672C\u4F1A\u6301\u7EED\u68C0\u67E5\u6BD4\u8D5B\u5730\u56FE\uFF1B\u82E5\u5929\u6C14\u53D8\u4E3A\u5965\u79D8\u6D8C\u6D41\uFF0C\u5219\u89E3\u9664\u672C\u573A\u8DF3\u8FC7\u5E76\u81EA\u52A8\u8FD4\u56DE\u3002\u5173\u95ED\u65F6\u4ECD\u4FDD\u6301\u79BB\u573A\u5230\u6BD4\u8D5B\u7ED3\u675F\u3002");
  ...
  var SECTION_HINTS = {
    ...
    worldboss: "\u652F\u6301\u6D17\u70B9\u6253\u5F31\u70B9\uFF0C\u6216\u6309\u6307\u5B9A Boss \u914D\u88C5\u8BA1\u7B97\u6700\u9AD8\u4F24\u5BB3\u5C5E\u6027\u4E14\u4E0D\u6D17\u70B9\u3002Boss \u9996\u51FB\u5FEB\u7167\u9501\u5B9A\u524D\u6301\u6709\u914D\u88C5\u63A7\u5236\u6743\uFF0C\u9501\u5B9A\u540E\u4F18\u5148\u4EA4\u8FD8\u516C\u4F1A\u8D5B/\u4E2A\u4EBA\u8D5B\u3002",
    sacrifice: "\u26A0\uFE0F \u6D4B\u8BD5\u9636\u6BB5\u529F\u80FD\u3002\u5EFA\u8BAE\u5F00\u542F\u8C03\u8BD5\u65E5\u5FD7\u89C2\u5BDF\u68C0\u67E5\u3001\u63D0\u4EA4\u548C\u8FBE\u6807\uFF1B\u5F02\u5E38\u65F6\u7ACB\u5373\u5173\u95ED\uFF0C\u5E76\u5230\u53CD\u9988\u9875\u63D0\u4EA4 bug\u3002\u8D44\u6E90\u4E0D\u8DB3\u65F6\u6BCF3\u5206\u949F\u91CD\u65B0\u68C0\u67E5\u5230\u672C\u8F6E\u5173\u95ED\uFF1B\u9C7C\u7C7B\u4F18\u5148\u7CBE\u51C6\u51D1\u5206\uFF0C\u51D1\u4E0D\u9F50\u65F6\u6700\u591A\u5141\u8BB8\u6BD4\u76EE\u6807\u591A30\u5206\u3002",
  ...
  function attachUI() {
    ...
    if (hintGuildBiomeBoost) {
      const hint = makeHint("\u52A0\u5165\u4E00\u652F\u53EF\u4EE5\u6B63\u5E38\u822A\u884C\u7684\u8239\u961F\u540E\uFF0C\u811A\u672C\u4F1A\u67E5\u770B\u8239\u961F\u6240\u5728\u5730\u56FE\u662F\u5426\u5DF2\u6709\u516C\u4F1A\u589E\u76CA\u3002\u6CA1\u6709\u589E\u76CA\u4E14\u4F60\u7684\u516C\u4F1A\u804C\u4F4D\u6709\u6743\u5F00\u542F\u65F6\uFF0C\u6BCF\u6B21\u8D2D\u4E70 1 \u4EFD\uFF0830 \u5206\u949F\uFF0C\u4F7F\u7528\u516C\u4F1A\u91D1\u5E93 500,000 \u91D1\u5E01\uFF09\u3002\u8239\u961F\u79DF\u8D41\u5230\u671F\u3001\u7B49\u5F85\u4FDD\u517B\u6216\u5176\u4ED6\u6210\u5458\u6B63\u5728\u5F00\u542F\u65F6\u4E0D\u4F1A\u91CD\u590D\u8D2D\u4E70\u3002");
...
<div id="update-popup" style="display:none;position:fixed;inset:0;z-index:2147483601;background:rgba(15,23,42,0.45);align-items:center;justify-content:center;">
  ...
  async function checkGuildBiomeBoost(trigger = "\u81EA\u52A8\u68C0\u67E5", runtime = null) {
    ...
    if (!partyState.target) {
      logOnce2("info", "\u6682\u4E0D\u8D2D\u4E70", partyState.message, `party:${partyState.status}`, runtime);
    ...
    try {
      ...
      logOnce2("info", "\u68C0\u67E5", `${target.biomeName}\u76EE\u524D\u6CA1\u6709\u516C\u4F1A\u589E\u76CA\uFF0C\u6B63\u5728\u786E\u8BA4\u662F\u5426\u9700\u8981\u8D2D\u4E70`, `checking:${target.biomeId}`, runtime);
      ...
      if (boost?.isQueued) {
        logOnce2("info", "\u7B49\u5F85", `\u5DF2\u6709\u5176\u4ED6\u6210\u5458\u6B63\u5728\u4E3A${target.biomeName}\u5F00\u542F\u516C\u4F1A\u589E\u76CA\uFF0C\u672C\u6B21\u4E0D\u91CD\u590D\u8D2D\u4E70`, `queued:${target.biomeId}`, runtime);
        return { status: "active", biomeId: target.biomeId };
      }
      if (overview?.canActivate !== true) {
        state._guildBiomeBoostNextAttemptAt = Date.now() + GUILD_BOOST_PERMISSION_BACKOFF_MS;
        logOnce2("warn", "\u6682\u4E0D\u8D2D\u4E70", `\u4F60\u5F53\u524D\u7684\u516C\u4F1A\u804C\u4F4D\u4E0D\u80FD\u5F00\u542F${target.biomeName}\u7684\u516C\u4F1A\u589E\u76CA\uFF0C\u672C\u6B21\u4E0D\u4F1A\u8D2D\u4E70`, `permission:${target.biomeId}`, runtime);
        return { status: "forbidden", biomeId: target.biomeId };
      }
      const wait = runtime?.wait || ((ms) => new Promise((resolve) => setTimeout(resolve, ms)));
      await wait(runtime ? 0 : 1200 + Math.floor(Math.random() * 1800));
      if (!sameBoatBiome(game, target.biomeId)) {
        logOnce2("info", "\u5DF2\u53D6\u6D88", "\u7B49\u5F85\u671F\u95F4\u8239\u961F\u5730\u56FE\u6216\u8239\u53EA\u72B6\u6001\u53D1\u751F\u4E86\u53D8\u5316\uFF0C\u672C\u6B21\u4E0D\u518D\u8D2D\u4E70", `moved:${target.biomeId}`, runtime);
      ...
      write2("info", "\u8D2D\u4E70", `${trigger}\uFF1A\u51C6\u5907\u4E3A${target.biomeName}\u8D2D\u4E70 1 \u4EFD\u516C\u4F1A\u589E\u76CA${unitCost ? `\uFF0C\u5C06\u4F7F\u7528\u516C\u4F1A\u91D1\u5E93 ${unitCost.toLocaleString("zh-CN")} \u91D1\u5E01` : ""}`, runtime);
      ...
      write2("info", "\u8D2D\u4E70\u6210\u529F", `${target.biomeName}\u7684\u516C\u4F1A\u589E\u76CA\u5DF2\u5F00\u542F${formatEndTime(active?.endsAt)}`, runtime);
      ...
      logOnce2("error", "\u672A\u6210\u529F", "\u8FD9\u6B21\u68C0\u67E5\u6216\u8D2D\u4E70\u6CA1\u6709\u6210\u529F\uFF0C5 \u5206\u949F\u540E\u4F1A\u81EA\u52A8\u91CD\u8BD5", `error:${target.biomeId}`, runtime);
  ...
  function startGuildBiomeBoost() {
    if (state._guildBiomeBoostTimer) return;
    write2("info", "\u5DF2\u542F\u7528", "\u5DF2\u5F00\u542F\u8239\u961F\u5730\u56FE\u516C\u4F1A\u589E\u76CA\uFF1A\u8239\u961F\u53EF\u4EE5\u6B63\u5E38\u822A\u884C\u4E14\u5F53\u524D\u5730\u56FE\u6CA1\u6709\u589E\u76CA\u65F6\uFF0C\u4F1A\u81EA\u52A8\u5C1D\u8BD5\u8D2D\u4E70 1 \u4EFD");
    scheduleGuildBiomeBoostCheck("\u542F\u7528\u540E\u68C0\u67E5");
    state._guildBiomeBoostTimer = setInterval(() => scheduleGuildBiomeBoostCheck("\u5B9A\u65F6\u68C0\u67E5"), GUILD_BOOST_SNAPSHOT_INTERVAL_MS);
  }
  function stopGuildBiomeBoost() {
    const wasRunning = Boolean(state._guildBiomeBoostTimer || state._guildBiomeBoostScheduleTimer);
    if (state._guildBiomeBoostTimer) clearInterval(state._guildBiomeBoostTimer);
    if (state._guildBiomeBoostScheduleTimer) clearTimeout(state._guildBiomeBoostScheduleTimer);
    state._guildBiomeBoostTimer = null;
    state._guildBiomeBoostScheduleTimer = null;
    state._guildBiomeBoostNextAttemptAt = 0;
    state._guildBiomeBoostLastLogSig = "";
    if (wasRunning) write2("info", "\u5DF2\u5173\u95ED", "\u5DF2\u5173\u95ED\u8239\u961F\u5730\u56FE\u516C\u4F1A\u589E\u76CA\uFF0C\u4E0D\u518D\u81EA\u52A8\u68C0\u67E5\u6216\u8D2D\u4E70");
  }
