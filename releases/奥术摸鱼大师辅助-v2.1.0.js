...
(() => {
  ...
  var TAG_COLORS = { "\u5730\u56FE\u5BFC\u822A": "#4a9eff", "\u6BD4\u8D5B\u8F85\u52A9": "#4ade80", "\u4E16\u754C Boss": "#f472b6", "\u5965\u79D8\u732E\u796D": "#8b5cf6", "\u5730\u56FE\u4E13\u7CBE": "#0d9488", "\u516C\u4F1A\u533A\u57DF\u589E\u76CA": "#16a34a", "\u5C5E\u6027\u52A0\u70B9": "#f59e0b", "\u9C7C\u9975\u5207\u6362": "#fbbf24", "Buff \u8D2D\u4E70": "#e6a23c", "\u51FA\u552E\u9C7C\u7C7B": "#eab308", "\u51FA\u552E\u88C5\u5907": "#a855f7", "\u901A\u7528\u8F85\u52A9": "#2dd4bf", "\u663E\u793A\u4E0E\u7EDF\u8BA1": "#c084fc", "\u53CD\u9988": "#38bdf8", "\u4E3B\u7A0B\u5E8F": "#64748b" };
...
${body}`;
  ...
  function renderPartyFinanceSection() {
    ...
    ctr.appendChild(_sellSwitchRow("\u91D1\u5E93\u8DB3\u989D\u65F6\u81EA\u52A8\u7EED\u8D39", !!settings.autoPartyRenewal, (enabled) => {
      ...
      saveSettings();
      applySettings();
    }, "\u79DF\u8D41\u8239\u961F\u7684\u4EFB\u610F\u6210\u5458\u90FD\u53EF\u7EED\u8D39\uFF1B\u91D1\u5E93\u591F\u652F\u4ED8\u4E00\u4EFD\u6240\u9009\u8D39\u7528\u65F6\uFF0C\u81EA\u52A8\u7EED\u8D39\u4E00\u4EFD\u3002"));
    const modeRow = document.createElement("label");
    modeRow.className = "switch-item";
    const modeText = document.createElement("span");
    modeText.textContent = "\u7EED\u8D39\u6A21\u5F0F";
    modeText.appendChild(makeHint("\u9009\u62E9\u6BCF\u6B21\u7EED\u8D39 1 \u5C0F\u65F6\u6216 1 \u5929\uFF1B\u811A\u672C\u53EA\u6309\u5F53\u524D\u9009\u62E9\u6267\u884C\u3002"));
    const mode = document.createElement("select");
    mode.style.cssText = "width:112px;height:26px;border:1px solid var(--as-border);border-radius:3px;background:var(--as-raised);color:var(--as-text);font:inherit;font-size:11px;";
    for (const [value, label] of [["hour", "\u6309\u5C0F\u65F6\uFF081\u5C0F\u65F6\uFF09"], ["day", "\u6309\u65E5\uFF081\u5929\uFF09"]]) {
      const option = document.createElement("option");
      option.value = value;
      option.textContent = label;
      option.selected = settings.partyRenewalBillingUnit === value;
      mode.appendChild(option);
    }
    mode.addEventListener("change", () => {
      settings.partyRenewalBillingUnit = mode.value === "day" ? "day" : "hour";
      saveSettings();
      if (settings.autoPartyRenewal) checkPartyFinance("\u7EED\u8D39\u6A21\u5F0F\u53D8\u66F4");
    });
    modeRow.append(modeText, mode);
  ...
  function attachUI() {
    ...
    if (hintGuildBiomeBoost) {
      const hint = makeHint("\u6709\u6743\u9650\u4E14\u5F53\u524D\u5730\u56FE\u6CA1\u6709\u589E\u76CA\u65F6\uFF0C\u4F7F\u7528\u516C\u4F1A\u91D1\u5E93 500,000 \u91D1\u5E01\u5F00\u542F 30 \u5206\u949F\u589E\u76CA\u3002");
...
<aside class="dock" data-collapsed="false" aria-label="\u5965\u672F\u6478\u9C7C\u5927\u5E08">
  ...
  <div class="panel-body">
    ...
    <div class="section" data-section="party-finance" data-settings-category="daily" data-collapsed="true">
      <div class="section-heading" data-accordion><strong>\u8239\u961F\u8D39\u7528\u4E0E\u7EED\u8D39</strong></div>
...
<div id="update-popup" style="display:none;position:fixed;inset:0;z-index:2147483601;background:rgba(15,23,42,0.45);align-items:center;justify-content:center;">
  ...
  function getRenewalPlan(overview, billingUnit = settings.partyRenewalBillingUnit) {
    if (billingUnit !== "hour" && billingUnit !== "day") return null;
    const crew = overview?.crew;
    ...
    const unitCost = Number(billingUnit === "hour" ? boat?.hourlyRentalGold : boat?.dailyRentalGold);
  ...
  async function checkPartyRenewal(trigger = "\u5B9A\u65F6\u68C0\u67E5", runtime = null, suppliedOverview = null) {
    ...
    const configuredMode = settings.partyRenewalBillingUnit;
    if (configuredMode !== "hour" && configuredMode !== "day") return { status: "invalid-mode" };
    const fetchOverview2 = runtime?.fetchOverview || (() => apiFetch("/api/party-boats/overview"));
    const renew = runtime?.renew || ((body2, key) => apiFetch("/api/party-boats/rental/extend", { method: "POST", body: body2, idempotencyKey: key }));
    let overview = suppliedOverview || await fetchOverview2();
    const plan = getRenewalPlan(overview, configuredMode);
    if (!plan) {
      logOnce4("info", "\u81EA\u52A8\u7EED\u8D39", `${trigger}\uFF1A\u5F53\u524D\u672A\u52A0\u5165\u53EF\u7EED\u8D39\u7684\u79DF\u8D41\u8239\u961F\uFF0C\u7B49\u5F85\u4E0B\u6B21\u68C0\u67E5`, "renew:unavailable", runtime);
      return { status: "unavailable" };
    }
    if (plan.treasuryGold < plan.unitCost) {
      logOnce4("info", "\u81EA\u52A8\u7EED\u8D39", `${trigger}\uFF1A\u8239\u961F\u91D1\u5E93\u4E0D\u8DB3\uFF0C\u5F53\u524D ${plan.treasuryGold.toLocaleString("zh-CN")}\uFF0C\u7EED\u8D39 1 ${configuredMode === "day" ? "\u5929" : "\u5C0F\u65F6"}\u9700\u8981 ${plan.unitCost.toLocaleString("zh-CN")}\uFF1B\u7A0D\u540E\u4F1A\u5728 10\uFF5E15 \u5206\u949F\u5185\u91CD\u65B0\u68C0\u67E5`, `renew:insufficient:${configuredMode}:${plan.unitCost}:${plan.treasuryGold}`, runtime);
    ...
    overview = await fetchOverview2();
    const confirmedPlan = getRenewalPlan(overview, settings.partyRenewalBillingUnit);
    if (!confirmedPlan || settings.partyRenewalBillingUnit !== configuredMode || confirmedPlan.rentalEndsAt !== plan.rentalEndsAt || confirmedPlan.unitCost !== plan.unitCost || confirmedPlan.treasuryGold < confirmedPlan.unitCost) return { status: "changed-before-submit" };
    ...
    try {
      ...
      const after2 = getRenewalPlan(overview, configuredMode);
      ...
      writeLog(confirmed2 ? "info" : "warn", "\u81EA\u52A8\u7EED\u8D39", confirmed2 ? `\u8BF7\u6C42\u867D\u5F02\u5E38\uFF0C\u4F46\u5DF2\u786E\u8BA4\u7EED\u8D39 1 ${configuredMode === "day" ? "\u5929" : "\u5C0F\u65F6"}\uFF0C\u6D88\u8017 ${plan.unitCost.toLocaleString("zh-CN")} \u91D1\u5E01` : `\u7ED3\u679C\u65E0\u6CD5\u786E\u8BA4\uFF08${error2?.message || error2}\uFF09\uFF0C\u5F53\u524D\u79DF\u671F\u7194\u65AD\u4E14\u4E0D\u518D\u91CD\u8BD5`, runtime);
    ...
    const after = getRenewalPlan(overview, configuredMode);
    ...
    writeLog(confirmed ? "info" : "warn", "\u81EA\u52A8\u7EED\u8D39", confirmed ? `\u5DF2\u7EED\u8D39 1 ${configuredMode === "day" ? "\u5929" : "\u5C0F\u65F6"}\uFF0C\u6D88\u8017 ${plan.unitCost.toLocaleString("zh-CN")} \u91D1\u5E01\uFF0C\u79DF\u671F\u5DF2\u786E\u8BA4\u589E\u52A0` : "\u63D0\u4EA4\u8FD4\u56DE\u6210\u529F\u4F46\u79DF\u671F\u672A\u589E\u52A0\uFF1B\u5F53\u524D\u79DF\u671F\u7194\u65AD\u4E14\u4E0D\u518D\u63D0\u4EA4", runtime);
  ...
  function startPartyFinance() {
    ...
    writeLog("info", "\u68C0\u67E5", "\u8239\u961F\u8D39\u7528\u529F\u80FD\u5DF2\u542F\u52A8\uFF1A\u73B0\u5728\u68C0\u67E5\u4E00\u6B21\uFF0C\u6B64\u540E\u6BCF 10\uFF5E15 \u5206\u949F\u968F\u673A\u68C0\u67E5\uFF1B\u6BCF\u65E5\u4E0A\u7F34\u6309\u5317\u4EAC\u65F6\u95F4\u65E5\u671F\u5224\u65AD", null);
  }
